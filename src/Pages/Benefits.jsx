...
function Benefits() {
  return (
    <div className="w-full h-[25rem] benefits">
      ...
      <div className="w-[80%] h-[30%] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-5 mx-auto">
        <div className="shadow-xl flex flex-col justify-center bg-white p-4 gap-2 hover:bg-gradient-to-r from-yellow-200 to-orange-400 hover:text-white  benefits_css">
          <div className="flex flex-row gap-2">
            <img src={time} alt="time" />
            <p className="text-md font-semibold text-[#FC8320]">Time Saving</p>
          </div>
        ...
        <div className="shadow-xl flex flex-col justify-center bg-white p-4 gap-2 hover:bg-gradient-to-r from-cyan-200 to-cyan-500 hover:text-white benefits_css">
          <div className="flex flex-row gap-2">
            <img src={insight} alt="insight" />
...
quickly for informed decision-making.
          </p>
        </div>
        <div className="shadow-xl flex flex-col justify-center bg-white p-4 gap-2 hover:bg-gradient-to-r from-[#7fa7ff] to-[#407bff] hover:text-white benefits_css">
          <div className="flex flex-row gap-2">
            <img src={emp} alt="emp" />
...
leading to increased engagement.
        ...
        <div className="shadow-xl flex flex-col justify-center bg-white p-4 gap-2 hover:bg-gradient-to-r from-[#81fa7f] to-[#16f112] hover:text-white benefits_css">
          <div className="flex flex-row gap-2">
            <img src={scale} alt="scale" />
            <p className="text-md font-semibold text-[#16F112]">Scalability</p>
          </div>
          <p className="text-black text-[0.7rem] sm:text-xs font-medium">
          Adaptable solutions to accommodate 
organizational growth effortlessly.
          </p>
        </div>
      </div>
    </div>
